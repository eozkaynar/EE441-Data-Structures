        ...
        if(str[i]==' ')
            ...
            switch (str[i])
            {
                case '+':
                {
                    ...
                    InsertFront(head,type_operator,ot1);
                    break;
                }
                ...
                case '-':
                {
                    ...
                    InsertFront(head,type_operator,ot2);
                    break;
                }
                case '*':
                {
                    OperatorToken ot3(multiplication,type_operator);
                    InsertFront(head,type_operator,ot3);
                    break;
                }
                case '/':
                {
                    OperatorToken ot4(division,type_operator);
                    InsertFront(head,type_operator,ot4);
                    break;
                }
                default:
                {
                    ...
                    InsertFront(head,type_number,nt);
                }
